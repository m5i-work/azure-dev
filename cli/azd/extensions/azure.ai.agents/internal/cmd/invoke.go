...
turn, or --cancel to cancel saved work. For remote Invocations agents, message-free
--resume performs one best-effort GET of the latest saved invocation without polling or
interpreting its lifecycle. In multi-agent projects, pass the agent name positionally.
Saved-work operations are remote-only, do not support raw output, and cannot be combined
with --timeout.`,
